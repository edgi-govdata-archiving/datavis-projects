  ...
  <div id="map">
	...
	<div id="primary" class="content-area">
      ...
      <div id="map_info" class="page type-page status-publish hentry">
          <h1 id="map_title" class="title-post entry-title">Guerrilla Archiving Toronto</h1>
          <h4 id="map_location">Toronto, Ontario</h4>
          <h4 id="map_date">2016/12/17</h4>
          <h4 id="map_attendees">Est Attendees: 150</h4>
          <h4 id="map_website"><a href="https://technoscienceunit.wordpress.com/2016/12/04/guerrilla-archiving-event-saving-environmental-data-from-trump/" target="_blank">Website</a></h4>
          <p id="map_description">Call to Action: Care about Trump, data, or the environment?<br />Join us for a full day of hackathon activities in preparation for the Trump presidency. <br />Date: 10am-4pm, December 17, 2016 <br />Location: Bissell Building, 4th Floor, 140 St. George St. University of Toronto <br />RSVP and up-to-date information: https://www.facebook.com/events/1828129627464671/</p>
      </div>
			...
			<script src="https://envirodatagov.org/wp-includes/js/d3/d3.v4.min.js"></script>
